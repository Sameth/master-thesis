...
Každý graf sa dá triviálne ofarbiť s použitím hodnôt ${0, 2, 4, \ldots, 2(n-2), 2(n-1)}$ tak, že každému
vrcholu priradíme jedinečnú hodnotu. Keďže rozdiel každej dvojice hodnôt je aspoň $2$, žiadna dvojica
vrcholov nemôže porušiť podmienky $L(2,1)$-farbenia.
