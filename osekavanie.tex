...
$$O^*\left((k^2 - k)^p \alpha^{n - p \cdot \lfloor \frac{k}{2} \rfloor}\right) =
O^*\left(\alpha^{n} \cdot \frac{(k^2 - k)^p}{\alpha^{p \cdot \lfloor \frac{k}{2} \rfloor}}\right) = O^*\left(\alpha^n \cdot \left(\frac{(k^2 - k)^{\frac{1}{\lfloor \frac{k}{2} \rfloor}}}{\alpha}\right) \strut^{p \cdot \lfloor \frac{k}{2} \rfloor}\right) = O^*(\alpha^n)$$
