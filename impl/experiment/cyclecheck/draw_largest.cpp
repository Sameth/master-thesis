...
ll maxpp, bestother = -1;
vector<vector<bool> > bestmatrix;

ll grafov = 0, rovnakychgrafov = 0;
...
int main () {
    ...
    cout << "Mame " << rovnakychgrafov << " rovnakych grafov\n";
    cout << "Najlepsie mensie pp je " << bestother << "\n";
    save_graph(bestmatrix, name);
}
